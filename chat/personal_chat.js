...
userImg.src = `https://backend-q9fm.onrender.com/static/uploads/${profilePic}`;
...
function loadMessages() {
  fetch(`https://backend-q9fm.onrender.com/api/messages/${selectedUser}?from=${currentUser}`)
    .then(res => res.json())
    .then(messages => {
...
function updateUserStatus(isActive) {
  fetch('https://backend-q9fm.onrender.com/api/update-status', {
    method: 'POST',
